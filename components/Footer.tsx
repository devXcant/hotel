        ...
        <div className="max-container padding-container ">
            <div className='flex flex-row justify-between items-top'>
                ...
                <div>
                    ...
                    <div className='flex flex-row justify-between items-center gap-28 border p-4 my-4 rounded-lg border-purple-60 '>
                ...
                <div className='grid grid-cols-5'>
                    <div className='col-span-1'>
                        ...
                        <div key={home.label} className='py-3 text-ub-xs'>
                    ...
                    <div className='col-span-1 gap-y-6'>
                        ...
                        <div key={about.label} className='py-3 text-ub-xs'>
                    ...
                    <div className='col-span-1 gap-y-6'>
                        ...
                        <div key={property.label} className='py-3 text-ub-xs'>
                    ...
                    <div className='col-span-1 gap-y-6'>
                        ...
                        <div key={service.label} className='py-3 text-ub-xs'>
                    ...
                    <div className='col-span-1 gap-y-6'>
                        ...
                        <div key={contact.label} className='py-3 text-ub-xs'>
